<template>
  <div class="container mx-auto">
    <div class="flex flex-wrap mt-4 mb-4 px-4">
      <div class="mb-10">
        <div class="inline-block relative w-24">
          <select
            class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded-full shadow leading-tight focus:outline-none"
          >
            <option>体型</option>
    ...
    <div class="flex flex-wrap px-4">
      <div class="w-40 mb-10 px-1">
        <div class="max-w-sm overflow-hidden">
          ...
          />
          <div class="pt-4 pb-4">
            <p class="text-grey-darker text-xs">一緒にお出かけ、嬉しい</p>
          </div>
          <div class="flex items-center">
            ...
            />
            <div class="text-sm">
              <p class="text-gray-900 leading-none">もみじ</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="w-40 mb-10 px-1">
        <div class="max-w-sm overflow-hidden">
          ...
          />
          <div class="pt-4 pb-4">
            <p class="text-grey-darker text-xs text-left">一緒にお出かけ、嬉しいね</p>
          </div>
          <div class="flex items-center">
            <img
              class="w-10 h-10 rounded-full mr-4"
      ...
      <div class="w-40 mb-10 px-1">
        <div class="max-w-sm overflow-hidden">
          ...
          />
          <div class="pt-4 pb-4">
            <p class="text-grey-darker text-xs text-left">一緒にお出かけ、嬉しいよね</p>
          </div>
          <div class="flex items-center">
            <img
              class="w-10 h-10 rounded-full mr-4"
    ...
    <button type="“button”" onclick="#">もっと見る</button>
